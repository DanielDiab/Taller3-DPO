...
public class Aerolinea
{
    ...
    public Collection<Tiquete> getTiquetes() {
        List<Tiquete> todosTiquetes = new LinkedList<>();
        for (Vuelo vuelo : vuelos) {
    ...
    public int venderTiquetes(String identificadorCliente, String fecha, String codigoRuta, int cantidad) throws VueloSobrevendidoException, Exception {
        ...
        Vuelo vuelo = getVueloPorFechaYRuta(fecha, codigoRuta);
        if (vuelo == null) {
            throw new Exception("No se encontró un vuelo en la fecha " + fecha + " con la ruta " + codigoRuta);
        }
        
        // Determinar si es temporada alta o baja
        ...
        // Vender los tiquetes a través del método de Vuelo
        return vuelo.venderTiquetes(cliente, calculadora, cantidad);
    }
    
    /**
     * Método auxiliar para encontrar un vuelo por su fecha y ruta.
     */
    private Vuelo getVueloPorFechaYRuta(String fecha, String codigoRuta) {
        for (Vuelo v : vuelos) {
    ...
    public String consultarSaldoPendienteCliente(String identificadorCliente) {
        ...
        for (Tiquete tiquete : getTiquetes()) {
        	if (tiquete.getClienteComprador().equals(cliente) && !tiquete.isUsado()) {
